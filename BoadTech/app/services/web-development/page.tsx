...
const technologies = [
  ...
  "Tailwind CSS", "SASS/SCSS", "Framer Motion", "WebGL"
];

const features = [
  {
    title: "Custom Web Applications",
    description: "Tailored solutions that perfectly match your business requirements and workflows."
  },
  {
  ...
  },
  {
    ...
    description: "Easy-to-use platforms for managing your digital content and assets."
  }
];
        ...
        <div className="container px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                ...
                We build fast, scalable, and user-friendly websites that drive results.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span>Expert team of full-stack developers</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-primary mr-2 mt-1" />
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Let's discuss how we can help you achieve your digital goals with our web development expertise.
            </p>
            <Button asChild size="lg">
              <Link href="/contact">
                Get in Touch
